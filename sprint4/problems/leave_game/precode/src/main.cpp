...
int main(int argc, const char* argv[]) {
    try {
        ...
        args.value().config_file = "E:/GitHub/cpp-game-backend/sprint4/problems/leave_game/precode/data/config.json";
        args.value().is_randomize_spawn_points = true;
        args.value().save_state_period = 50;
        args.value().state_file = "E:/GitHub/cpp-game-backend/sprint4/problems/leave_game/precode/file";
        args.value().tick_period = 10;
        args.value().www_root = "E:/GitHub/cpp-game-backend/sprint4/problems/leave_game/precode/static";
        if (args) {
            postgres::Database db(8, "postgres://postgres:PupkiN@localhost:5432/postgres");
        //DEBUG
        //if (auto args = ParseCommandLine(argc, argv)) {
            ...
            //postgres::Database db(num_threads, DB_URL_ENV_NAME);
