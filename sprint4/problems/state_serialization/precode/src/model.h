...
public:
    ...
    void TickPlayer(double delta_time, double game_dog_speed, std::function<const Map* (const Map::Id&)> map_searcher, std::function<const GameSession* (const GameSession::Id&)> session_searcher);
...
public:
    ...
    void TickPlayers(double delta_time, double game_dog_speed, std::function<const Map* (const Map::Id&)> map_searcher, std::function<const GameSession* (const GameSession::Id&)> session_searcher);
