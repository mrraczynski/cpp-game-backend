...
int main(int argc, const char* argv[]) {
    try {
        ...
        if (auto args = ParseCommandLine(argc, argv)) {
            ...
            model::Game game = json_loader::LoadGame(/*"E:/Projects/GitHub/cpp-game-backend/sprint2/problems/command_line/precode/data/config.json"*/ args.value().config_file,
            ...
            std::shared_ptr<http_handler::RequestHandler> handler = std::make_shared<http_handler::RequestHandler>(game,
                /*"E:/Projects/GitHub/cpp-game-backend/sprint2/problems/command_line/precode/static/"*/ args.value().www_root,
                ioc,
