...
int main(int argc, const char* argv[]) {
    ...
    try {
        ...
        model::Game game = json_loader::LoadGame("E:/Projects/GitHub/cpp-game-backend/sprint2/problems/game_state/precode/data/config.json"/*argv[1]*/ );
        ...
        std::shared_ptr<http_handler::RequestHandler> handler = std::make_shared<http_handler::RequestHandler>(game, 
            "E:/Projects/GitHub/cpp-game-backend/sprint2/problems/game_state/precode/static/"/* argv[2]*/, 
            ioc);
